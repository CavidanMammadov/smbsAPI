...
{
    public class UpdateMissionAndVisionCommand:IRequest<IResult<DomainSuccess<MissionAndVisionResult>,DomainError>>
    {
        public int MissionAndVisionId { get; set; }
        public string MissionAndVisionTitle { get; set; }
        public string MissionAndVisionContent { get; set; }
       
    }
    public class UpdateMissionAndVisionCommandValidator : AbstractValidator<UpdateMissionAndVisionCommand>
    {
        public UpdateMissionAndVisionCommandValidator()
        {
