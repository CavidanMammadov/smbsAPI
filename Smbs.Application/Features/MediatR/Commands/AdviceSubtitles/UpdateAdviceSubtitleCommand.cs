...
{
    public class UpdateAdviceSubtitleCommand:IRequest<IResult<DomainSuccess<AdviceSubtitleResult>, DomainError>>
    {
    ...
    public class UpdateAdviceSubtitleCommandValidator : AbstractValidator<UpdateAdviceSubtitleCommand>
    {
        public UpdateAdviceSubtitleCommandValidator()
        {
            RuleFor(a => a.AdviceSubtitleId).NotEmpty().WithMessage("Cannot be empty");
