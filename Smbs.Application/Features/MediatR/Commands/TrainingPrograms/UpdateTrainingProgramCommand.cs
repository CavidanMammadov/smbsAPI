...
{
    public class UpdateTrainingProgramCommand : IRequest<IResult<DomainSuccess<TrainingProgramResult>, DomainError>>
    {
    ...
    public class UpdateTrainingProgramCommandValidator : AbstractValidator<UpdateTrainingProgramCommand>
    {
        ...
        {
            RuleFor(x => x.TrainingProgramId).GreaterThan(0).WithMessage("Id must be greater than 0");
