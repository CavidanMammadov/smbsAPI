...
{
    public class CreateProgramDownloadingCommand:IRequest<IResult<DomainSuccess<ProgramDownloadingResult>,DomainError>>
    {
    ...
    public class CreateProgramDownloadingValidator:AbstractValidator<CreateProgramDownloadingCommand>
    {
        public CreateProgramDownloadingValidator()
        {
