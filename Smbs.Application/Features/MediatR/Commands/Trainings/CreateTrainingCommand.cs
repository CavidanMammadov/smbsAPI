...
{
    public class CreateTrainingCommand:IRequest<IResult<DomainSuccess<TrainingResult>,DomainError>>
    {
    ...
    public class CreateTrainingCommandValidator : AbstractValidator<CreateTrainingCommand>
    {
        public CreateTrainingCommandValidator()
        {
           ...
           RuleFor(x => x.TrainingDescription)
            ...
            RuleFor(x => x.TrainingPrice).GreaterThanOrEqualTo(0).WithMessage("Training price must be greater than or equal to 0.");
