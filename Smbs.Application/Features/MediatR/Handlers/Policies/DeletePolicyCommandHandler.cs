...
{
    public class DeletePolicyCommandHandler(IRepository<Policy> repository) : IRequestHandler<DeletePolicyCommand, IResult<DomainSuccess<int>, DomainError>>
    {
        public async Task<IResult<DomainSuccess<int>, DomainError>> Handle(DeletePolicyCommand request, CancellationToken cancellationToken)
        {
