...
{
    public class DeleteAdviceSubtitleCommandHandler(IRepository<AdviceSubtitle> repository) : IRequestHandler<DeleteAdviceSubtitleCommand, IResult<DomainSuccess<int>, DomainError>>
    {
        public async Task<IResult<DomainSuccess<int>, DomainError>> Handle(DeleteAdviceSubtitleCommand request, CancellationToken cancellationToken)
        {
